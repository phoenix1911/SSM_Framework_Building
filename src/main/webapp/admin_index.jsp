    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">功能介绍</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="admin_v1.jsp" data-index="0">功能介绍</a>
                            </li>
                    ...
                    <li>
                        <a href="#">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">学生教师信息维护</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">功能维护</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#">
                            <i class="fa fa-home"></i>
                            <span class="nav-label">公告维护</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="admin_v1.jsp" frameborder="0" data-id="admin_v1.html" seamless></iframe>
            </div>
